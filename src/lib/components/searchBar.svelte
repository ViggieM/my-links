...
<div class="p-2">
  <label class="input input-bordered pr-0 flex cursor-text items-stretch">
    <input
    ...
    <button class="p-3 pr-4 hover:bg-secondary/50 hover:text-secondary-content rounded-e-full" title="Create" aria-label="Create">
			<svg
